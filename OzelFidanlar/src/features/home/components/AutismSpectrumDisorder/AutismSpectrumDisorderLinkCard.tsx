...
const AutismSpectrumDisorderLinkCard = ({
  ...
  return (
    <div
      className="rounded-md border border-gray-300 p-5 bg-sky-300/20 
    motion-safe:hover:bg-white shadow-lg shadow-gray-500 transition-all duration-300 motion-safe:hover:-translate-y-1 motion-safe:hover:shadow-xl"
    >
      <h3 className="mb-2 text-base lg:text-xl font-semibold text-gray-800 border-b border-gray-300 pb-2">
        {title}
      </h3>
