...
interface LanguageAndSpeechDisordersLinkCardProps {
  title: string;
  description: string;
  path: string;
}

const LanguageAndSpeechDisordersLinkCard = ({
  title,
  description,
  path,
}: LanguageAndSpeechDisordersLinkCardProps) => {
  return (
    <div className="rounded-md border border-gray-300 bg-sky-300/20 p-5 shadow-lg shadow-gray-500 transition-all duration-300 hover:-translate-y-1 motion-safe:hover:bg-white motion-safe:hover:shadow-xl">
      <h3 className="mb-2 border-b border-gray-300 pb-2 text-base lg:text-xl font-semibold text-gray-800">
        {title}
      </h3>
...
export default LanguageAndSpeechDisordersLinkCard;
