...
import { adolescenceCounselingData } from "../../data/AdolescentCounseling/adolescentCounseling";

const AdolescenceCounselingSection = () => {
  const { hero, about, benefits, scope, targetAudience, note } =
    adolescenceCounselingData;
            ...
            <main className="space-y-10 md:space-y-12 lg:space-y-14">
              ...
              <section>
                <h3 className="mb-4 text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">
                  Ergenlik Danışmanlığı Size Neler Kazandırır?
                </h3>
...
export default AdolescenceCounselingSection;
