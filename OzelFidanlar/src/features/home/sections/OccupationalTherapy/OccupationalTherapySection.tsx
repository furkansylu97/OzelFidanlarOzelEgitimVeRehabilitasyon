            ...
            <div className="my-10 md:my-12 lg:my-14 grid grid-cols-1 gap-10 lg:gap-12">
              {highlights.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="group flex max-w-sm md:max-w-md lg:max-w-xl gap-4 rounded-md border border-gray-300 p-5 shadow-lg shadow-gray-500 transition-all duration-300 motion-safe:hover:-translate-y-1 hover:shadow-xl"
                  >
