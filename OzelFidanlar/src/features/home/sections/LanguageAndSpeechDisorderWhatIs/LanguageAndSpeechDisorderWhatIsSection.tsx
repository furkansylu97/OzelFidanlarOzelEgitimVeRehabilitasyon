...
const LanguageAndSpeechDisorderWhatIsSection: React.FC = () => {
  const { hero, intro, paragraphs, highlights, closing } =
    languageAndSpeechDisorderWhatIs;
    ...
    <section className="relative w-full">
      ...
      <div className="relative mt-2 lg:-mt-32 flex justify-center">
        <div className="w-full max-w-sm md:max-w-xl lg:max-w-3xl rounded-sm bg-white p-10 shadow-xl shadow-gray-500">
          ...
          <div className="space-y-6 text-base lg:text-lg leading-relaxed text-gray-600 lg:mt-6">
...
export default LanguageAndSpeechDisorderWhatIsSection;
