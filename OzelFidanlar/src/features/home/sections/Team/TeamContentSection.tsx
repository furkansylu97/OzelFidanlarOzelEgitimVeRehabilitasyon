    ...
    <section>
      <div className="flex justify-center mb-16">
        <div className="flex flex-col items-center justify-center">
          <div className="pt-24">
            <h1 className="inline-block pl-1 mb-6 text-2xl font-bold border-l-4 border-amber-300 bg-[#001064]/10 text-gray-900">
              Kadromuz
            </h1>
          </div>

          <div className="flex items-center justify-center text-center max-w-4xl pb-16 border-b border-gray-300">
            <p className="text-lg">
