...
import { familyEducationCounselingData } from "../../data/FamilyEducationCounseling/familyEducaitonCounseling";

const FamilyEducationCounselingSection = () => {
  const { hero, about, benefits, scope, targetAudience, note } =
    familyEducationCounselingData;
            ...
            <main className="space-y-10 md:space-y-12 lg:space-y-14">
              ...
              <section>
                <h3 className="mb-4 text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">
                  Aile Eğitimi Size Neler Kazandırır?
                </h3>

                <ul className="space-y-2 lg:space-y-3 text-gray-700">
                  {benefits.map((item, index) => (
                    <li key={index} className="flex lg:items-center gap-2 lg:gap-3 text-base lg:text-lg">
              ...
              <section>
                ...
                <ul className="space-y-2 lg:space-y-3 text-gray-700">
                  {scope.map((item, index) => (
                    <li key={index} className="flex lg:items-center gap-2 lg:gap-3">
...
export default FamilyEducationCounselingSection;
