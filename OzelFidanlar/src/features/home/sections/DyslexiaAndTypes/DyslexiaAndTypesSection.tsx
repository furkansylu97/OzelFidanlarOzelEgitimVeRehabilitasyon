...
const DyslexiaAndTypesSection: React.FC = () => {
  const { hero, intro, paragraphs, highlights, closing } = dislexiaAndTypes;
    ...
    <section className="relative w-full">
      ...
      <div className="relative mt-2 lg:-mt-32 flex justify-center">
        <div className="w-full max-w-sm md:max-w-xl lg:max-w-3xl rounded-sm bg-white p-10 shadow-xl shadow-gray-500">
          ...
          <div className="mt-0 lg:mt-6 space-y-6 text-base lg:text-lg leading-relaxed text-gray-600">
            {paragraphs.map((text, i) => (
              <p key={i}>{text}</p>
            ))}
          </div>

          <div className="lg:flex lg:justify-center lg:items-center my-6 lg:my-8">
            <h2 className="inline-block border-l-4 border-amber-300 bg-[#001064]/10 pl-1 text-xl lg:text-2xl font-bold text-gray-900">
              Disleksi Çeşitleri
            </h2>
          </div>

          <div className="flex items-center justify-center">
            <div className="my-6 md:my-8 lg:my-10 grid grid-cols-1 gap-10 lg:gap-12">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-2">
                      ...
                      <p className="my-2 text-base lg:text-lg text-gray-600">
                        {item.text}
                      </p>
                    </div>
                  </div>
...
export default DyslexiaAndTypesSection;
